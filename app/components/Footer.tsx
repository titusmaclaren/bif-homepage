...
const socials = [
  ...
  },
  {
    ...
    label: "Instagram",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" aria-hidden>
        ...
        <div className="flex-none text-right md:text-right max-md:text-left">
          ...
          <div className="flex gap-3 mb-4 justify-end max-md:justify-start">
            {socials.map((s) => (
              ...
              >
                <span className="flex w-5 h-5 items-center justify-center [&_svg]:h-full [&_svg]:w-full">
                  {s.icon}
                </span>
              </a>
            ))}
